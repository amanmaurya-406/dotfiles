# Generated by Powerlevel10k configuration wizard on 2025-12-19 at 14:23 IST.
...
() {
  ...
  ########################################[ user ]#############################################
  #User color
  typeset -g POWERLEVEL9K_USER_FOREGROUND=39
  ...
  # Default context format (no privileges, no SSH): bold username.
